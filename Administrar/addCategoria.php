...
if(isset($_POST['nome'])){
    ...
    $query = $conexao -> prepare("INSERT INTO categorias (nome) VALUES (?)");
...
if (isset($_SESSION['yetu-debliw'])) {
    ...
    <body>
        <div class="principal">
            <a href="index.php" class="titulo"><h2>ADD CATEGORIA</h2></a>
            <div class="principal-corpo">
                <form action="addCategoria.php" method="post" autocomplete="off">
